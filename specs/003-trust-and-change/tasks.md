...
- [x] T033 [AR] Read `process.env.N8N_CHECK_DATA_DIR` in `src/trust/persistence.ts:119-121` as fallback before hardcoded default — SD-002, FR-013, US4-S6
