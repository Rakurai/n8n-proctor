...
> Research document for the n8n-proctor project. Catalogs all n8n-as-code (n8nac) functionality relevant to workflow validation, testing, execution inspection, and development workflow management. Source: n8n-as-code repository at /Users/QTE2333/repos/n8n-as-code.
...
**Relevance to n8n-proctor:** Credential checking is a pre-validation step. If a workflow requires credentials that don't exist, execution-backed validation will fail for reasons unrelated to the workflow logic.
...
**Gap:** Current change detection is workflow-level, not node-level. For n8n-proctor's slice-based validation, finer-grained change tracking (which specific nodes/connections changed) would be needed.
...
## 11. Capability Summary for n8n-proctor

### What n8nac provides that n8n-proctor can build on
...
### What n8nac does NOT provide (gaps for n8n-proctor)
...
### Integration points for n8n-proctor

n8n-proctor should likely integrate with n8nac rather than replace it:
